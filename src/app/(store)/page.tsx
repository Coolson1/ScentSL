        ...
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12">
          <Reveal className="mb-16 flex flex-col items-baseline justify-between gap-6 sm:flex-row">
            <div>
              ...
              <h2 className="mt-3 font-display text-[clamp(2.4rem,5vw,4rem)] font-light leading-[0.95] tracking-[-0.01em] text-ink">
                Curated <em className="italic text-brand-gold">best sellers</em> & coveted scents
              </h2>
            </div>
            <Link
              href="/products"
          ...
          <ProductGrid
            products={popular}
            emptyMessage="Popular selections will appear here once marked in the admin panel."
          />
        </div>
      </section>
